...
namespace Assets.SimpleLocalization.Scripts
{
    ...
    public static class LocalizationManager
    {
        ...
        public static LanguageManagerSO ManagerSO {get; private set;}
        public static void Read(LanguageManagerSO managerSO)
        {
            ManagerSO = managerSO;
            Read();
        }
        ...
        public static TMP_FontAsset GetFont() => ManagerSO.GetFont();
        public static TMP_FontAsset GetFont(string Language) => ManagerSO.GetFont(ManagerSO.LanguageLists.IndexOf(Language));
